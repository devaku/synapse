                        ...
                        content: (
                            <div className="mx-40">
                                <div className="flex my-10 justify-around gap-5">
                                    ...
                                    <div className="bg-ttg-black/8 size-fit p-4 rounded-sm flex-1">
                                        <h3 className="text-xl font-semibold">Urgent Tasks</h3>
                            ...
                            <div>
                                ...
                                <div className="flex justify-around mt-10 mx-40">
                                    <div className="w-[28%] h-100">
                                        <h3 className="text-2xl font-semibold text-center">Top Ten Breakdown</h3>
                                        <Pie data={pieChartData}></Pie>
                                    </div>
                                    <div className="w-[60%] h-100">
                                        <h3 className="text-2xl font-semibold text-center">Past Months Comparison</h3>
