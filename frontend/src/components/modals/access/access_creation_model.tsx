// Mostly generated by ChatGPT with minor tweaks
...
type FormValues = {
	...
	permission: 'pull' | 'push' | 'admin' | 'maintain';
};
...
export default function AccessCreationModal({
	...
	async function onSubmit(data: FormValues) {
		...
		if (!repoNumToCheck || isNaN(repoNumToCheck) || repoNumToCheck <= 0) {
			setSubmitError('Select a valid repository');
			return;
		}
		...
		<div className="p-4">
			...
			>
				...
				<div className="flex gap-2 mt-4">
					{/* Use native buttons with explicit types to avoid double-submission caused by
					    the custom Button component rendering a <button> without a type (defaults to submit)
					    while also calling handleSubmit onClick. */}
					<button
						type="submit"
