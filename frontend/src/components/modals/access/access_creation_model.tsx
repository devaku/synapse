...
export default function AccessCreationModal({
    ...
    async function onSubmit(data: FormValues) {
        ...
        if (!serverData?.id) {
            alert('User information not available. Please refresh or login again.');
            return;
        }
        ...
        <div className="p-4 min-w-[320px]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
                ...
                <div className="flex flex-col">
                    ...
                    <select {...register('permission')} className="p-2 border rounded-md">
                ...
                <div className="flex gap-2 mt-4">
                    ...
                    <button type="button" className="px-3 py-2 border rounded" onClick={handleModalDisplay}>
                        Cancel
                    </button>
                </div>
                {submitError && (
